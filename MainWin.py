...
class MainWin( wx.Frame ):
	...
	def menuAbout( self, event ):
		...
		info.Description = wordwrap( unicode(
			...
			"If ranking by 'Points Only' (eg. Points Race), riders are ranked by:\n"
			"  1.  Most Points\n"
			...
			"If ranking by 'Distance, then Points' (eg. Madison), riders are ranked by:\n"
			...
			"If ranking by 'Distance, Points, Num Wins' (eg. Criterium with Points), riders are ranked by:\n"
			"  1.  Most Distance Covered (as adjusted by Laps +-)\n"
			"  2.  If a tie, by Most Points\n"
